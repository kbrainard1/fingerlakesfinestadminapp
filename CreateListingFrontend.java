...
public class CreateListingFrontend {
    ...
    public static final String GITHUB_REPO = "kbrainard1/fingerlakesfinest";
    ...
    static JButton createListing;
    static JButton markPlaced;
    ...
    public static void main(String[] args) throws Exception {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                createListing = new CustomButton("Add New Available Horse");
                markPlaced = new CustomButton("Mark Horse As Placed");
                enableButtons();
